import { fill3DRect } from './snippets/LearningWASM-6f958a70a1b921fe/helper.js';
...
export function handleMouseClick(mouseX, mouseY) {
    const ret = wasm.handleMouseClick(mouseX, mouseY);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('LearningWASM_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
